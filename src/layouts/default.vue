...
const DefaultLayoutWithTabsVerticalNav = defineAsyncComponent(() => import('./components/DefaultLayoutWithTabsVerticalNav.vue'))
...
<template>
  ...
  <template v-else-if="appContentLayoutNav === AppContentLayoutNav.TabsVertical">
    <DefaultLayoutWithTabsVerticalNav v-bind="layoutAttrs" />
  </template>
  <template v-else>
